...
Розробити віртуальний клас "Car" (Автомобіль). Можна скористатись вже розробленим раніше в уроці 6, тільки допрацювати його. В даному класі зібрати всі спільні поля, властивості, методи, наприклад, максимальна швидкість, «збільшити швидкість», «зменшити швидкість». 
...
Клас гри повинен випадковим чином генерувати склад машин, які приймають участь в гонці і за допомогою розроблених делегатів управляти їх параметрами (випадковим чином), наприклад, впливати на швидкість руху. 
